...
const animalGroups = [
  {
    ...
    facts: [
      ...
      "They dream just like humans do",
      "Our hens enjoy over 8 hours of free-range time daily",
    ],
  },
  {
    id: "ducks",
    ...
    facts: [
      ...
      "They can eat up to 200 slugs per day",
    ],
  },
  {
    id: "turkeys",
    ...
    facts: [
      "Turkey eggs are 50% larger than chicken eggs",
      "Heritage turkeys can fly short distances",
      "They have excellent eyesight and memory",
    ],
  },
  {
    id: "geese",
    ...
    facts: [
      "Geese mate for life and are devoted parents",
      "One goose egg equals about 3 chicken eggs",
      "They're excellent 'guard dogs' for the flock",
    ],
  },
  {
    id: "goats",
    ...
    facts: [
      "Nigerian Dwarf goats produce milk with high butterfat",
      "Goats are incredibly intelligent and curious",
    ...
    <>
      ...
      <section className="relative py-20 bg-gradient-to-br from-soft-gold to-barn-red">
        <div className="container-custom text-center">
          ...
          >
            <p className="font-accent text-cream text-2xl mb-4">The Stars of the Show</p>
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl text-white mb-6">
              Meet the Animals
            </h1>
            <p className="text-white/80 max-w-2xl mx-auto text-lg">
              Every animal at Besso Ranch has a name, a personality, and a purpose.
              Get to know the wonderful creatures that make our products possible.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="container-custom">
            <div className={`grid md:grid-cols-2 gap-12 items-center ${index % 2 === 1 ? "md:flex-row-reverse" : ""}`}>
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <p className="font-accent text-soft-gold text-xl mb-2">{group.tagline}</p>
                <h2 className="section-title mb-4">{group.name}</h2>
                <p className="text-charcoal-400 leading-relaxed mb-6">{group.description}</p>
              ...
              <motion.div
                className={`aspect-square bg-warm-brown/10 rounded-2xl flex items-center justify-center ${index % 2 === 1 ? "md:order-1" : ""}`}
                initial={{ opacity: 0, x: index % 2 === 0 ? 30 : -30 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
              >
                <span className="text-warm-brown/50 font-heading">{group.name} Photo Gallery</span>
              </motion.div>
            </div>
          </div>
        </section>
